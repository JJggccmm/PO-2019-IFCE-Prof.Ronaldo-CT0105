...
#CT0105 – Quinta contribuição da primeira etapa                                                            #
...
def cria_Graficos(lista_entrada):                                                                                                                                                                                                                                                                          #
  ...
  for i in lista_entrada:                                                                                                                                                                                                                                                                                  #
    ...
    num_iteracoes = 0                                                                                                                                                                                                                                                                                      #
                                                                                                                                                                                                                                                                                                           #
  desenhaGrafico(lista_entrada,tempos_orden,"GraficoMergeSort(Tamanho_Lista-X-Tempo_Ordenacoes)Lista_Aleatoria.png", "Tempo(Lista->Aleatoria)",'(Merge Sort-Lista Aleatória)Tamanho_Lista X Tempo_Ordenacoes','black',"<Entradas/>","<Tempo-Saída/>")                                                      #
  desenhaGrafico(lista_entrada, numer_iteracoes,"GraficoMergeSort(Tamanho_Lista-X-Numero_Iteracoes)Lista_Aleatoria.png", "Numero_Iteracao(Lista->Aleatoria)",'(Merge Sort-Lista Aleatória)Tamanho_Lista X Numero_Iteracoes','red',"<Entradas/>","<'Swaps'(Num_Iterações)-Saída/>")                         #
                                                                                                                                                                                                                                                                                                           #
  #desenhaGrafico(lista_entrada,tempos_orden,"GraficoMergeSort(Tamanho_Lista-X-Tempo_Ordenacoes)Lista_Decrescente.png", "Tempo(Lista->Decrescente)",'(Merge Sort-Lista Decrescente)Tamanho_Lista X Tempo_Ordenacoes','black',"<Entradas/>","<Tempo-Saída/>")                                               #
  #desenhaGrafico(lista_entrada, numer_iteracoes,"GraficoMergeSort(Tamanho_Lista-X-Numero_Iteracoes)Lista_Decrescente.png", "Numero_Iteracao(Lista->Decrescente)",'(Merge Sort-Lista Decrescente)Tamanho_Lista X Numero_Iteracoes','red',"<Entradas/>","<'Swaps'(Num_Iterações)-Saída/>")                  #                                                                                                                                                                                                                                                                                            
                                                                                                                                                                                                                                                                                                           #                                                                                                                                                                                                                                                                                                           
############################################################################################################################################################################################################################################################################################################
